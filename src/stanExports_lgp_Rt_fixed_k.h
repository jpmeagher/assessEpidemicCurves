...
namespace model_lgp_Rt_fixed_k_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_lgp_Rt_fixed_k");
    reader.add_event(89, 87, "end", "model_lgp_Rt_fixed_k");
    return reader;
}
#include <stan_meta_header.hpp>
class model_lgp_Rt_fixed_k
  : public stan::model::model_base_crtp<model_lgp_Rt_fixed_k> {
private:
        int D_seed;
        int D;
        std::vector<int> y;
        ...
        vector_d log_omega;
public:
    model_lgp_Rt_fixed_k(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_lgp_Rt_fixed_k_namespace::model_lgp_Rt_fixed_k";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_lgp_Rt_fixed_k_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_lgp_Rt_fixed_k_namespace::model_lgp_Rt_fixed_k stan_model;
#ifndef USING_R
