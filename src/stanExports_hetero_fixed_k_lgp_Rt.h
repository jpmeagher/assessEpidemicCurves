...
namespace model_hetero_fixed_k_lgp_Rt_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_hetero_fixed_k_lgp_Rt");
    reader.add_event(114, 112, "end", "model_hetero_fixed_k_lgp_Rt");
    return reader;
}
#include <stan_meta_header.hpp>
class model_hetero_fixed_k_lgp_Rt
  : public stan::model::model_base_crtp<model_hetero_fixed_k_lgp_Rt> {
private:
        int D_seed;
        int D;
        std::vector<int> y;
        ...
        vector_d log_omega;
public:
    model_hetero_fixed_k_lgp_Rt(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_hetero_fixed_k_lgp_Rt_namespace::model_hetero_fixed_k_lgp_Rt";
        ...
        try {
            ...
            pos__ = 0;
            D = vals_i__[pos__++];
            check_greater_or_equal(function__, "D", D, D_seed);
            ...
            validate_non_negative_index("log_eta", "D", D);
            num_params_r__ += D;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("log_eta", "D", D);
        context__.validate_dims("parameter initialization", "log_eta", "vector_d", context__.to_vec(D));
        Eigen::Matrix<double, Eigen::Dynamic, 1> log_eta(D);
        size_t log_eta_j_1_max__ = D;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                log_eta = in__.vector_constrain(D, lp__);
            else
                log_eta = in__.vector_constrain(D);
            current_statement_begin__ = 50;
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("eta_rep");
        names__.push_back("psi_rep");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_hetero_fixed_k_lgp_Rt_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        Eigen::Matrix<double, Eigen::Dynamic, 1> log_eta = in__.vector_constrain(D);
        size_t log_eta_j_1_max__ = D;
        for (size_t j_1__ = 0; j_1__ < log_eta_j_1_max__; ++j_1__) {
        ...
        try {
            ...
            validate_non_negative_index("eta_rep", "D", D);
            Eigen::Matrix<double, Eigen::Dynamic, 1> eta_rep(D);
            stan::math::initialize(eta_rep, DUMMY_VAR__);
            stan::math::fill(eta_rep, DUMMY_VAR__);
            current_statement_begin__ = 85;
            validate_non_negative_index("psi_rep", "D", D);
            Eigen::Matrix<double, Eigen::Dynamic, 1> psi_rep(D);
            stan::math::initialize(psi_rep, DUMMY_VAR__);
            stan::math::fill(psi_rep, DUMMY_VAR__);
            current_statement_begin__ = 86;
            validate_non_negative_index("y_rep", "(D - D_seed)", (D - D_seed));
            Eigen::Matrix<double, Eigen::Dynamic, 1> y_rep((D - D_seed));
            ...
            double psi_ahead;
            (void) psi_ahead;  // dummy to suppress unused var warning
            stan::math::initialize(psi_ahead, DUMMY_VAR__);
            stan::math::fill(psi_ahead, DUMMY_VAR__);
            current_statement_begin__ = 89;
            double log_lik_ahead;
            (void) log_lik_ahead;  // dummy to suppress unused var warning
            ...
            for (int i = 1; i <= D; ++i) {
                current_statement_begin__ = 91;
                stan::model::assign(eta_rep, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            gamma_rng((k * get_base1(y_reg, i, "y_reg", 1)), (k / get_base1(R, i, "R", 1)), base_rng__), 
                            "assigning variable eta_rep");
            }
            current_statement_begin__ = 92;
            stan::math::assign(psi_rep, rep_vector(0, D));
            ...
            for (int i = 2; i <= D; ++i) {
                ...
                if (as_bool(logical_lte(i, S))) {
                    ...
                    for (int j = 1; j <= (i - 1); ++j) {
                        ...
                        stan::model::assign(psi_rep, 
                                    stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                    (get_base1(psi_rep, i, "psi_rep", 1) + (get_base1(eta_rep, (i - j), "eta_rep", 1) * get_base1(omega, j, "omega", 1))), 
                                    "assigning variable psi_rep");
                    }
                } else {
            ...
            for (int i = (D_seed + 1); i <= D; ++i) {
                ...
                stan::model::assign(y_rep, 
                            stan::model::cons_list(stan::model::index_uni((i - D_seed)), stan::model::nil_index_list()), 
                            poisson_rng((get_base1(mu, i, "mu", 1) + get_base1(psi_rep, i, "psi_rep", 1)), base_rng__), 
                            "assigning variable y_rep");
            }
            current_statement_begin__ = 109;
            stan::math::assign(psi_ahead, 0);
            current_statement_begin__ = 110;
            for (int i = 1; i <= S; ++i) {
                current_statement_begin__ = 110;
                stan::math::assign(psi_ahead, (psi_ahead + (get_base1(eta, ((D - i) + 1), "eta", 1) * get_base1(omega, i, "omega", 1))));
            }
            current_statement_begin__ = 111;
            stan::math::assign(log_lik_ahead, poisson_log(y_ahead, (mu_ahead + psi_ahead)));
            // validate, write generated quantities
            current_statement_begin__ = 84;
            size_t eta_rep_j_1_max__ = D;
            for (size_t j_1__ = 0; j_1__ < eta_rep_j_1_max__; ++j_1__) {
                vars__.push_back(eta_rep(j_1__));
            }
            current_statement_begin__ = 85;
            size_t psi_rep_j_1_max__ = D;
            for (size_t j_1__ = 0; j_1__ < psi_rep_j_1_max__; ++j_1__) {
                vars__.push_back(psi_rep(j_1__));
            }
            current_statement_begin__ = 86;
            size_t y_rep_j_1_max__ = (D - D_seed);
            ...
            current_statement_begin__ = 88;
            check_greater_or_equal(function__, "psi_ahead", psi_ahead, 0);
            vars__.push_back(psi_ahead);
            current_statement_begin__ = 89;
            vars__.push_back(log_lik_ahead);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    std::string model_name() const {
        return "model_hetero_fixed_k_lgp_Rt";
    }
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_1__ = 0; j_1__ < eta_rep_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "eta_rep" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        size_t psi_rep_j_1_max__ = D;
        for (size_t j_1__ = 0; j_1__ < psi_rep_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "psi_rep" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        size_t y_rep_j_1_max__ = (D - D_seed);
        for (size_t j_1__ = 0; j_1__ < y_rep_j_1_max__; ++j_1__) {
        ...
        param_name_stream__.str(std::string());
        param_name_stream__ << "psi_ahead";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "log_lik_ahead";
        param_names__.push_back(param_name_stream__.str());
    }
...
typedef model_hetero_fixed_k_lgp_Rt_namespace::model_hetero_fixed_k_lgp_Rt stan_model;
#ifndef USING_R
