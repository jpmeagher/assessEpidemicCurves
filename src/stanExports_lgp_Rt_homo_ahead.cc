...
#include "stanExports_lgp_Rt_homo_ahead.h"

RCPP_MODULE(stan_fit4lgp_Rt_homo_ahead_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_lgp_Rt_homo_ahead")
