...
#include "stanExports_hetero_fixed_k_lgp_Rt.h"

RCPP_MODULE(stan_fit4hetero_fixed_k_lgp_Rt_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_hetero_fixed_k_lgp_Rt")
