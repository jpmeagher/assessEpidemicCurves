...
namespace model_lgp_Rt_homo_ahead_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_lgp_Rt_homo_ahead");
    reader.add_event(91, 89, "end", "model_lgp_Rt_homo_ahead");
    return reader;
}
#include <stan_meta_header.hpp>
class model_lgp_Rt_homo_ahead
  : public stan::model::model_base_crtp<model_lgp_Rt_homo_ahead> {
private:
        int D_seed;
        int D;
        std::vector<int> y;
        ...
        vector_d log_omega;
public:
    model_lgp_Rt_homo_ahead(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_lgp_Rt_homo_ahead_namespace::model_lgp_Rt_homo_ahead";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_lgp_Rt_homo_ahead_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            for (int i = 1; i <= S; ++i) {
                current_statement_begin__ = 86;
                stan::math::assign(psi_ahead, (psi_ahead + ((get_base1(R, ((D - i) + 1), "R", 1) * get_base1(y_reg, ((D - i) + 1), "y_reg", 1)) * get_base1(omega, i, "omega", 1))));
            }
    ...
    std::string model_name() const {
        return "model_lgp_Rt_homo_ahead";
    }
...
typedef model_lgp_Rt_homo_ahead_namespace::model_lgp_Rt_homo_ahead stan_model;
#ifndef USING_R
