...
namespace model_lgp_Rt_fixed_k_ahead_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_lgp_Rt_fixed_k_ahead");
    reader.add_event(99, 97, "end", "model_lgp_Rt_fixed_k_ahead");
    return reader;
}
#include <stan_meta_header.hpp>
class model_lgp_Rt_fixed_k_ahead
  : public stan::model::model_base_crtp<model_lgp_Rt_fixed_k_ahead> {
private:
        int D_seed;
        int D;
        std::vector<int> y;
        ...
        vector_d log_omega;
public:
    model_lgp_Rt_fixed_k_ahead(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_lgp_Rt_fixed_k_ahead_namespace::model_lgp_Rt_fixed_k_ahead";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_lgp_Rt_fixed_k_ahead_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            double y_rep_ahead;
            (void) y_rep_ahead;  // dummy to suppress unused var warning
            ...
            stan::math::assign(y_rep_ahead, poisson_rng((mu_ahead + psi_ahead), base_rng__));
    ...
    std::string model_name() const {
        return "model_lgp_Rt_fixed_k_ahead";
    }
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "y_rep_ahead";
        param_names__.push_back(param_name_stream__.str());
    }
...
typedef model_lgp_Rt_fixed_k_ahead_namespace::model_lgp_Rt_fixed_k_ahead stan_model;
#ifndef USING_R
