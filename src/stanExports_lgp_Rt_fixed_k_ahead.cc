...
#include "stanExports_lgp_Rt_fixed_k_ahead.h"

RCPP_MODULE(stan_fit4lgp_Rt_fixed_k_ahead_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_lgp_Rt_fixed_k_ahead")
