...
namespace model_homo_hist_Rt_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_homo_hist_Rt");
    reader.add_event(85, 83, "end", "model_homo_hist_Rt");
    return reader;
}
#include <stan_meta_header.hpp>
class model_homo_hist_Rt
  : public stan::model::model_base_crtp<model_homo_hist_Rt> {
private:
        int D_seed;
        int D;
        std::vector<int> y;
        ...
        vector_d log_omega;
public:
    model_homo_hist_Rt(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_homo_hist_Rt_namespace::model_homo_hist_Rt";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            validate_non_negative_index("tmp_psi_matrix", "D", D);
            validate_non_negative_index("tmp_psi_matrix", "S", S);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, Eigen::Dynamic> tmp_psi_matrix(D, S);
            ...
            for (int i = 1; i <= D; ++i) {
                ...
                stan::model::assign(R, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            get_base1(r, (divide(i, delta) + 1), "r", 1), 
                            "assigning variable R");
            }
            current_statement_begin__ = 54;
            stan::math::assign(tmp_psi_matrix, rep_matrix(stan::math::negative_infinity(), D, S));
                ...
                if (as_bool(logical_lte(i, S))) {
                    ...
                    for (int j = 1; j <= (i - 1); ++j) {
                        ...
                        stan::model::assign(tmp_psi_matrix, 
                                    ...
                                    (stan::math::log((get_base1(y_reg, (i - j), "y_reg", 1) * get_base1(R, (i - j), "R", 1))) + get_base1(log_omega, j, "log_omega", 1)), 
                                    "assigning variable tmp_psi_matrix");
                    }
                } else {
            ...
            current_statement_begin__ = 47;
            size_t tmp_psi_matrix_j_1_max__ = D;
            ...
            lp_accum__.add(lognormal_log<propto__>(r, mean_log_r, sd_log_r));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_homo_hist_Rt_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            validate_non_negative_index("tmp_psi_matrix", "D", D);
            validate_non_negative_index("tmp_psi_matrix", "S", S);
            Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> tmp_psi_matrix(D, S);
            stan::math::initialize(tmp_psi_matrix, DUMMY_VAR__);
            stan::math::fill(tmp_psi_matrix, DUMMY_VAR__);
            current_statement_begin__ = 48;
            validate_non_negative_index("psi", "D", D);
...
typedef model_homo_hist_Rt_namespace::model_homo_hist_Rt stan_model;
#ifndef USING_R
